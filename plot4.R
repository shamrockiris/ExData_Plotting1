...
par(mfrow=c(2,2))
plot(x=myData$Date_Time,y=myData$Global_active_power,xlab="",ylab="Global Active Power",pch=".")
lines(x=myData$Date_Time,y=myData$Global_active_power)
plot(x=myData$Date_Time,y=myData$Voltage,xlab="datetime",ylab="Voltage",pch=".")
lines(x=myData$Date_Time,y=myData$Voltage)
...
plot(x=myData$Date_Time,y=myData$Global_reactive_power,xlab="datetime",ylab="Global Reactive Power",pch=".")
lines(x=myData$Date_Time,y=myData$Global_reactive_power)
dev.off()